...
- __1995__ : _Classmates_ est l’un des premiers réseaux sociaux qui permettent aux étudiants de rester en relation. <img src="img/classmates.jpg" width=10%>
- __2003__ : apparition de Myspace, aujourd’hui en perte de vitesse, et de _LinkedIn_ (racheté depuis par Microsoft), à vocation professionnelle.  ![logo](img/myspace.png)
- __2004__ : apparition de _Facebook_, d’abord réservé aux étudiants de l’université Harvard, puis ouvert au grand public en 2006.  ![logo](img/facebook.png)
- __2006__ : apparition de _Twitter_, qui permet l’échange de courts messages, limités au départ à 140 puis à 280 caractères (on parle de microblogage). Aujourd'hui Twitter à changé de nom pour X.   ![logo](img/logo_x.png)
- __2009__ : lancement de la messagerie instantanée _WhatsApp_ (rachetée depuis par Facebook) qui se substitue à l’utilisation des SMS et MMS chez beaucoup d’utilisateurs.  ![logo](img/whatsapp.png)
- __2010__ : arrivée d’_Instagram_ (racheté depuis par Facebook), qui permet le partage de photos et de vidéos.  ![logo](img/insta.png)
- __2011__ : début de _Snapchat_ qui permet, sur plateformes mobiles, le partage de photos et de vidéos, avec une limitation de durée.  ![logo](img/snapchat.png)
- __2012__ : l’application chinoise de messagerie _Weixin_ voit le jour. Elle compte plus d'un milliard de comptes utilisateurs en 2018.  ![logo](img/weixin.png)
